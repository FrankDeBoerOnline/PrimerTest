...
namespace Tests\FrankDeBoerOnline\Configuration\Yamlenv;

use FrankDeBoerOnline\Configuration\Yamlenv\Loader;
use FrankDeBoerOnline\Configuration\Yamlenv\Exception\ImmutableException;
...
class LoaderTest extends TestCase
{
    ...
    {
        $this->folder = __DIR__ . '/fixtures/valid/env.yml';
    ...
    public function testMutableLoaderCanBeSetToImmutable()
    {
        ...
        $this->expectExceptionMessage('Environment variables cannot be overwritten in an immutable environment.');
    ...
    public function testFlattenNestedValuesThrowsExceptionWithDuplication()
    {
        ...
        $immutableLoader = new Loader(__DIR__ . '/fixtures/valid/duplicates_nested.yml', true);
