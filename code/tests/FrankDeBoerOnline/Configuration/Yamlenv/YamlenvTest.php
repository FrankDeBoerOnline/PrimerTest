...
namespace Tests\FrankDeBoerOnline\Yamlenv;

use FrankDeBoerOnline\Configuration\Yamlenv\Loader;
use FrankDeBoerOnline\Configuration\Yamlenv\Validator;
use FrankDeBoerOnline\Configuration\Yamlenv\Yamlenv;

use FrankDeBoerOnline\Configuration\Yamlenv\Exception\InvalidPathException;
use FrankDeBoerOnline\Configuration\Yamlenv\Exception\InvalidFileException;
use FrankDeBoerOnline\Configuration\Yamlenv\Exception\ValidationException;
use FrankDeBoerOnline\Configuration\Yamlenv\Exception\LoaderException;

use PHPUnit\Framework\TestCase;

class YamlenvTest extends TestCase
{
    /**
     * @var string
     */
    ...
    {
        $this->fixturesFolder = __DIR__ . '/fixtures/valid';
    }
    ...
    public function testSpacedValuesWithoutQuotesThrowsException()
    {
        ...
        $yamlenv = new Yamlenv(__DIR__ . '/fixtures/invalid', 'invalid.yml');
        $yamlenv->load();
    }
    ...
    public function testYamlenvRequiredIntegerEnvironmentVar()
    {
        ...
        $this->expectExceptionMessage('One or more environment variables failed assertions: FOO is not an integer.');
    ...
    {
        $this->expectException(ValidationException::class);
        $this->expectExceptionMessage('One or more environment variables failed assertions: FOO is not an allowed value.');
    ...
    {
        $this->expectException(ValidationException::class);
        $this->expectExceptionMessage('One or more environment variables failed assertions: LCVAR1 is missing, LCVAR2 is missing, LCVAR3 is missing.');
    ...
    {
        $this->expectException(ValidationException::class);
        $this->expectExceptionMessage('One or more environment variables failed assertions: ASSERTVAR3 is empty.');
